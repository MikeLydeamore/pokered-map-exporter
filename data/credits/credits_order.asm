...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_SPECIAL, CRED_J_IM, CRED_DANNY, CRED_PRET, CRED_TEXT_FADE
	...
	db CRED_PRODUCERS, CRED_MIYAMOTO, CRED_KAWAGUCHI, CRED_ISHIHARA, CRED_TEXT_MON
	db CRED_US_STAFF, CRED_TEXT_FADE
	db CRED_US_COORD, CRED_KAWAKAMI, CRED_HI_NAKAMURA, CRED_TILDEN, CRED_TEXT_FADE
	...
	db CRED_SPECIAL, CRED_IWATA, CRED_HARADA, CRED_TEXT_FADE
